...
<template>
   ...
   <div class="container">
     ...
     <div class="sidebar">
       <ul>
        <li>
        <router-link to="/noticeMain">공지사항</router-link>
        <router-link to="/noticeFAQ">FAQ</router-link>
      </li>
       </ul>
     </div>
...
td a {
  ...
  color: inherit; /* 색상 변경 안되게 설정 (부모 색상 상속) */
}

td a:hover {
  color: inherit; /* 호버 시 색상 변경 안되게 설정 */
}
