    ...
    <div class="page-background">
      ...
      <div class="mypage-container">
        <div class="sidebar">
          <ul>
            <!-- 아이콘 추가 -->
            <li><i class="fas fa-user"></i> 프로필</li>
            <li><i class="fas fa-file-alt"></i> 이력서 관리</li>
            <li><i class="fas fa-briefcase"></i> 지원 현황</li>
            <li><i class="fas fa-bookmark"></i> 스크랩</li>
            <li><i class="fas fa-certificate"></i> 자격증 관리</li>
          </ul>
        </div>
...
/* 사이드바 메뉴 항목 스타일 
   - 호버 효과로 사용자 상호작용 개선
   - 아이콘은 각 메뉴 항목 왼쪽에 배치 (예: fa-user, fa-file-alt 등) */
.sidebar ul li {
  font-size: 18px;
  cursor: pointer;
  padding: 15px 0;
