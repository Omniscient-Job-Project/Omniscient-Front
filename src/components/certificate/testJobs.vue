<template>
  <div class="curation-main-container">
    ...
    <div class="pagination">
      <button
        @click="goToTestJobsPage(1)"
        :disabled="currentTestJobsPage === 1"
        class="page-btn"
      >
        <i class="fas fa-angle-double-left"></i>
      </button>
      <button
        @click="prevTestJobsPage"
        :disabled="currentTestJobsPage === 1"
        class="page-btn"
      >
      ...
      <div class="page-numbers">
        <button
          v-for="pageNumber in displayedTestJobsPageNumbers"
          :key="pageNumber"
          @click="goToTestJobsPage(pageNumber)"
          :class="[
            'page-number',
            { active: currentTestJobsPage === pageNumber },
          ]"
        >
          {{ pageNumber }}
        </button>
      ...
      <button
        @click="nextTestJobsPage"
        :disabled="currentTestJobsPage === totalTestJobsPages"
        class="page-btn"
      >
        <i class="fas fa-angle-right"></i>
      </button>
      <button
        @click="goToTestJobsPage(totalTestJobsPages)"
        :disabled="currentTestJobsPage === totalTestJobsPages"
        class="page-btn"
      >
...
const nextTestJobsPage = () => {
  if (currentTestJobsPage.value < totalTestJobsPages.value)
    currentTestJobsPage.value++;
};
...
const displayedTestJobsPageNumbers = computed(() => {
  ...
  let end = Math.min(
    currentTestJobsPage.value + range,
    totalTestJobsPages.value
  );
